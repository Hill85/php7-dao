...
//===================================================================================
  // Método inserir
		...
		public function insert(){
			...
			$results = $sql->select("CALL sp_usuarios_insert(:LOGIN, :PASSWORD)", array(// Prossedures realiza a inserção no banco de dados 
...
//=================================================================================
	   	...
	   	public function update($Login, $password){ // Método para alterar login e senha 
